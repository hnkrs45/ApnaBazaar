...
import { addproduct, editproduct, removeproduct, updateproduct, checkAuth, getProducts, getAllOrders, updateOrderStatus, getAllUsers, getVendors, approveVendor, logout, getLast7DaysOrders, getSalesByVendors, getOrdersByCategory, getTotalDetail } from "../controller/admin.js";
...
router.get('/getallorders', checkAdmin, getAllOrders)
router.put('/updateorderstatus', checkAdmin, updateOrderStatus)
router.get('/getallusers', checkAdmin, getAllUsers)
